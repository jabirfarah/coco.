...
const ProductHunt = () => {
    ...
    return (
        <section id="product-hunt" className="h-full w-full border bg-white mb-2 shadow-xl flex flex-col flex-shrink-0 max-w-md">
            ...
            {productHuntItems.map((post) =>
                <div key={post.id} className="flex gap-2 hover:bg-gray-50 justify-between p-2">
